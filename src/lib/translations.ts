...
export const translations: Record<Language, Translations> = {
    en: {
        ...
        checkout: {
            ...
            fanProtectTitle: "FanProtect™",
            fanProtectDesc: "We back every order so you can buy and sell tickets with 100% confidence.",
            resellTitle: "Resell Anytime",
            resellDesc: "Not sure if you can make it to this event? No worries! You can resell your tickets on StubHub at any time.",
        },
        footer: {
    ...
    de: {
        ...
        checkout: {
            ...
            ticketmasterTrust: "🔒 Offizieller Ticketmaster Transfer: Ihre Tickets werden direkt an diese E-Mail-Adresse übertragen. 100% Sicher & Garantiert.",
            ...
            fanProtectTitle: "FanProtect™",
            fanProtectDesc: "Wir garantieren jede Bestellung, damit Sie Tickets mit 100% Sicherheit kaufen und verkaufen können.",
            resellTitle: "Jederzeit weiterverkaufen",
            resellDesc: "Unsicher, ob Sie zum Event können? Kein Problem! Sie können Ihre Tickets jederzeit auf StubHub weiterverkaufen.",
        },
        footer: {
    ...
    es: {
        ...
        checkout: {
            ...
            ticketmasterTrust: "🔒 Transferencia Oficial Ticketmaster: Tus entradas se transferirán directamente a este correo. 100% Seguro y Garantizado.",
            ...
            fanProtectTitle: "FanProtect™",
            fanProtectDesc: "Respaldamos cada pedido para que puedas comprar y vender entradas con 100% de confianza.",
            resellTitle: "Revender en cualquier momento",
            resellDesc: "¿No estás seguro de poder asistir? ¡No hay problema! Puedes revender tus entradas en StubHub en cualquier momento.",
        },
        footer: {
    ...
    fr: {
        ...
        checkout: {
            ...
            fanProtectTitle: "FanProtect™",
            fanProtectDesc: "Nous garantissons chaque commande pour que vous puissiez acheter et vendre des billets en toute confiance.",
            resellTitle: "Revendre à tout moment",
            resellDesc: "Pas sûr de pouvoir venir ? Pas de souci ! Vous pouvez revendre vos billets sur StubHub à tout moment.",
        },
        footer: {
